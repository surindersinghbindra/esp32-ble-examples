...
/* Colors to cycle through on each blink, in R, G, B order (0-255 each) */
...
static void blink_led(void)
{
    ...
    if (s_led_state) {
        /* Set the LED pixel to the next color in the cycle */
        const uint8_t *color = s_colors[s_color_index];
